...
from . import (  # noqa: E402
    discovery, projects, clips, editing, captions, transcribe, generation,
    watermark, music, assets, dashboard, inspection, render, comments, templates,
)

_MODULES = [discovery, projects, clips, editing, captions, transcribe,
            generation, watermark, music, assets, dashboard, inspection, render,
            comments, templates]
